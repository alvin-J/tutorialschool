...
<li><a href="<?php echo base_url(); ?>/logout"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url()."Counselor/enrollment" ?>" class="<?php echo ($title == "- Schedule")?"active-menu":""; ?> waves-effect waves-dark"> ENROLLMENT</a>
                    </li>
					<!--li>
 ...
 TUTORS</a>
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>teacher/reports" class="<?php echo ($title == "- Payment")?"active-menu":""; ?> waves-effect waves-dark"> HISTORY </a>
                    </li>
