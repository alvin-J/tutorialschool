...
<li><a href="<?php echo base_url(); ?>/logout"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url()."admin/students" ?>" class="<?php echo ($title == "- Schedule")?"active-menu":""; ?> waves-effect waves-dark"> STUDENTS</a>
                    </li>
					<li>
 ...
 TUTORS</a>
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>admin/reports/student" class="<?php echo ($title == "- Payment")?"active-menu":""; ?> waves-effect waves-dark"> REPORTS </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>admin/materials" class="<?php echo ($title == "- Payment")?"active-menu":""; ?> class="waves-effect waves-dark">MATERIALS </a>
                    </li>
                    
                    <li>
                        <a href="<?php echo base_url(); ?>admin/payslips" class="<?php echo ($title == "- Materials")?"active-menu":""; ?> waves-effect waves-dark"> PAYSLIPS </a>
                    </li>
